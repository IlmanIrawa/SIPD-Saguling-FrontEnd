        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item dropdown d-flex align-items-center" :class="isRTL ? 'ps-2' : 'pe-2'">
            ...
            <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4" :class="showRoleDropdown ? 'show' : ''">
              <li><a class="dropdown-item" @click="handleRoleSelection('ADMIN')">ADMIN</a></li>
              <li><a class="dropdown-item" @click="handleRoleSelection('USER')">USER</a></li>
              <li><a class="dropdown-item" @click="handleRoleSelection('FO')">FRONT OFFICE</a></li>
            </ul>
            <ul>
